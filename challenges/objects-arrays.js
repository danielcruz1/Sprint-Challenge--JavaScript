...
*/
const animalNames = [];
const name = zooAnimals.forEach((object) => {
...
*/
const lowerCase = [];
  smallName = zooAnimals.map(item => item.animal_name.toLowerCase());
...
lowerPopulation = zooAnimals.filter(popFive);
...
populationTotal = populationTotal.reduce(pop);
